...
void vex_vexpf( 
    ...
    const float32x4_t OVERFLOW_BOUND = vdupq_n_f32(88.37626f); 
    const float32x4_t UNDERFLOW_BOUND = vdupq_n_f32(-87.33654f); 
    ...
    for (size_t i = 0; i < chunk_count; i++) { 
        ...
        uint32x4_t valid_high = vcleq_f32(xv, OVERFLOW_BOUND);
        uint32x4_t valid_low  = vcgeq_f32(xv, UNDERFLOW_BOUND);
        ...
        float32x4_t xlog2ev = vmulq_n_f32(xv, LOG2E); 
